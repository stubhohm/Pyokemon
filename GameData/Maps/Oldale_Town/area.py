...
from ...Sprites.MapComponents.Sprites import generate_Oldale_NorthWest_House_map, generate_Oldale_SouthEast_House_map
...
from .ValidationDict import blocked_spaces_dict, house_1_blocked_dict
