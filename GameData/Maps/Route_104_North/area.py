...
from ...Sprites.MapComponents.MapImports import generate_route_104_North_map as generate_route_map
...
route_name = 'Route 104 North'
north_area_name = 'Rustboro City'
east_area_name = 'E'
west_area_name = 'W'
south_area_name = 'Petalburg Woods'
...
def set_below_player_render_items(route:Route):
    ...
    coords = [(8, 19), (8, 20), (10, 19), (3, 20), (32, 6), (36, 7)]
    make_item_dict(route, img_name, coords, 4, 60, 1)
    coords = [ (10, 20), (2, 19), (4, 19), (4, 20), (34, 7)]
    make_item_dict(route, img_name, coords, 4, 60, 2)
    coords = [(9, 19), (9, 20), (2, 20), (3, 19), (31, 4), (37, 7)]
